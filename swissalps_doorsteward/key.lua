...
print('is not owner or admin');
    ...
    local sFcheckboxLeaveOpen = 'checkbox[1.25,2;bLeaveOpen;Leave this door open;checkboxLeaveOpenLastField]';
    local sFcheckboxSteward = 'checkbox[1.25,2.4;bStewardActive;Use Steward on this door;checkboxStewardLastField]';
