...
print('is not owner or admin');
    ...
    local sFgroups = 'field[1,3.4;7,1;doors_groups;Door opens for members of these groups:;' .. sGroups .. ']';
    local sFbuttonOK = 'button_exit[4,4;4,1;buttonOK;OK]';
    local sFbuttonCancel = 'button_exit[1,4;3,1;buttonCancel;Cancel]';
